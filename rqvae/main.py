...
def parse_args():
    ...
    parser.add_argument("--data_path", type=str, default=f"../data/{DATASET}/item_emb.parquet", help="Input data path.")
    ...
    parser.add_argument("--ckpt_dir", type=str, default=f"./ckpt/{DATASET}", help="please specify output directory for model")
